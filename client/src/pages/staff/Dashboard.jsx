...
export default function Dashboard() {
  ...
  // Comprobación dinámica de permisos configurados en la base de datos
  const tienePermiso = (clavePagina) => {
    if (rolLogueado === 1) return true; // Administrador tiene superpoderes nativos
  ...
  // ── Vista General (Dinámica por Permisos) ──
  return (
    <div style={{ padding: "16px 20px", background: THEME.bg, minHeight: "calc(100vh - 60px)" }}>
      <style>{GLOBAL_CSS}</style>

      {/* Cartel de Alerta: Solo se muestra si tiene el permiso dinámico de ventas */}
      ...
      <div style={{
        ...
        {/* Panel Cobros Pendientes alternativo (Opcional, solo si tiene ventas pero no hubo actividad en el día) */}
