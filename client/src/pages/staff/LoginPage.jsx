...
function HowItWorks({ isMobile }) {
  ...
  return (
    <section style={{ 
      ...
      <div style={{ maxWidth: 1100, width: "100%", margin: "0 auto", padding: isMobile ? "0 24px" : "0 48px" }}>
...
function Footer({ isMobile }) {
  return (
    <footer style={{ background: P.forest, color: "rgba(255,255,255,0.75)", padding: isMobile ? "40px 18px 22px" : "52px 0 28px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: isMobile ? "0" : "0 48px", width: "100%" }}>
...
// ── Componente Principal Ajustado Conservando Tu Lógica Original ──
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", minHeight: "100vh", background: P.white }}>
      ...
      <section id="inicio" style={{
        padding: isMobile ? "100px 0 60px 0" : "140px 0 100px 0", // Padding superior por la Navbar fija
        ...
        <div style={{ maxWidth: 1100, width: "100%", margin: "0 auto", padding: isMobile ? "0 24px" : "0 48px", display: "flex", alignItems: "center", flexDirection: isMobile ? "column" : "row", gap: isMobile ? 40 : 72 }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            {!showForm && (
              <button onClick={() => setShowForm(true)} style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: 9, alignSelf: isMobile ? "stretch" : "flex-start", padding: "12px 26px", fontSize: 14, borderRadius: 11, background: `linear-gradient(135deg, ${P.forest}, ${P.pine})`, color: "white", border: "none", fontWeight: 700, cursor: "pointer", boxShadow: `0 6px 20px rgba(26,61,40,0.25)`, transition: "all 0.2s ease" }}>
                👤 Ingresar al sistema →
              </button>
            )}
          </div>

          <div style={{ display: isMobile ? "none" : "flex", flexDirection: "column", alignItems: "center", flexShrink: 0 }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: P.mint, border: `1px solid ${P.borderLight}`, borderRadius: 99, padding: "4px 14px", marginBottom: 16 }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: P.pine, letterSpacing: "0.04em" }}>Clínica Veterinaria San Roque</span>
            </div>
            <div style={{ width: 320, height: 320, display: "flex", borderRadius: 24, background: `linear-gradient(135deg, ${P.mint}, rgba(234,243,222,0.5))`, alignItems: "center", justifyContent: "center", boxShadow: `0 24px 48px rgba(26,61,40,0.1)`, border: `1px solid ${P.borderLight}`, padding: 24 }}>
              <img src="/logocolor.png" alt="Logo" style={{ width: "100%", height: "100%", objectFit: "contain" }} />
            </div>
          </div>
      ...
      {/* ── 2. SERVICIOS: Ajustado en simetría perfecta con 'Nosotros' ── */}
      <section id="servicios" style={{
        ...
        <div style={{ maxWidth: 1100, width: "100%", margin: "0 auto", padding: isMobile ? "0 24px" : "0 48px" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            <div style={{ display: "inline-block", fontSize: 12, fontWeight: 700, color: P.pine, background: P.mint, border: `1px solid ${P.borderLight}`, padding: "5px 16px", borderRadius: 99, marginBottom: 14, textTransform: "uppercase", letterSpacing: "0.07em" }}>¿Qué ofrecemos?</div>
            <h2 style={{ margin: "0 0 12px", fontSize: 30, fontWeight: 800, color: P.forest, letterSpacing: "-0.5px" }}>Nuestros servicios</h2>
            <p style={{ margin: 0, fontSize: 15, color: P.muted }}>Atención integral para el bienestar de tu mascota</p>
          </div>
      ...
      {/* ── 3. CÓMO FUNCIONA EL PORTAL ── */}
      <HowItWorks isMobile={isMobile} />

      {/* ── 4. SOBRE NOSOTROS (El bloque de referencia perfecta) ── */}
      <section id="nosotros" style={{
        ...
        <div style={{ maxWidth: 1100, width: "100%", margin: "0 auto", padding: isMobile ? "0 24px" : "0 48px" }}>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: isMobile ? 32 : 72, alignItems: "center" }}>
            <div style={{ background: `linear-gradient(135deg, ${P.forest}, ${P.pine})`, borderRadius: 24, padding: "48px 40px", display: "flex", flexDirection: "column", gap: 24 }}>
              <div style={{ fontSize: 48 }}>🏥</div>
              <h3 style={{ margin: 0, fontSize: 22, fontWeight: 800, color: "white" }}>Clínica Veterinaria San Roque</h3>
              <p style={{ margin: 0, fontSize: 13.5, color: "rgba(255,255,255,0.7)", lineHeight: 1.75 }}>Ubicada en Punta Alta, Buenos Aires. Contamos con veterinaria, asistente y atención personalizada para cada paciente.</p>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginTop: 8 }}>
                {[{ n: "5", l: "Roles de acceso" }, { n: "∞", l: "Mascotas atendidas" }, { n: "100%", l: "Historial digital" }, { n: "24/7", l: "Portal disponible" }].map((st, i) => (
                  <div key={i} style={{ background: "rgba(255,255,255,0.1)", borderRadius: 12, padding: "14px 16px", border: "1px solid rgba(255,255,255,0.12)" }}>
            ...
            <div>
              <div style={{ display: "inline-block", fontSize: 12, fontWeight: 700, color: P.pine, background: P.mint, border: `1px solid ${P.borderLight}`, padding: "5px 16px", borderRadius: 99, marginBottom: 20, textTransform: "uppercase", letterSpacing: "0.07em" }}>Sobre nosotros</div>
              <h2 style={{ margin: "0 0 18px", fontSize: 30, fontWeight: 800, color: P.forest, letterSpacing: "-0.5px" }}>Un sistema pensado para la clínica y para vos</h2>
              <p style={{ fontSize: 14.5, color: P.muted, lineHeight: 1.8, margin: "0 0 16px" }}>La Clínica Veterinaria San Roque digitalizó toda su gestión con un sistema web integral que unifica la administración clínica, comercial y el acceso de los clientes.</p>
              <p style={{ fontSize: 14.5, color: P.muted, lineHeight: 1.8, margin: 0 }}>Cada rol —administrador, veterinario, asistente, vendedor y cliente— tiene acceso a exactamente lo que necesita, garantizando seguridad y eficiencia en cada proceso.</p>
            </div>
          </div>
        </div>
      </section>

      {/* ── 5. CONTACTO: Ajustado en simetría perfecta con 'Nosotros' ── */}
      <section id="contacto" style={{
        ...
        <div style={{ maxWidth: 1100, width: "100%", margin: "0 auto", padding: isMobile ? "0 24px" : "0 48px" }}>
          <div style={{ textAlign: "center", marginBottom: 52 }}>
            <div style={{ display: "inline-block", fontSize: 12, fontWeight: 700, color: P.pine, background: P.mint, border: `1px solid ${P.borderLight}`, padding: "5px 16px", borderRadius: 99, marginBottom: 14, textTransform: "uppercase", letterSpacing: "0.07em" }}>Contacto</div>
            <h2 style={{ margin: "0 0 12px", fontSize: 30, fontWeight: 800, color: P.forest, letterSpacing: "-0.5px" }}>¿Necesitás ayuda?</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3, 1fr)", gap: 24 }}>
            {[
              ...
              <div key={i} style={{ padding: "32px 24px", borderRadius: 16, textAlign: "center", background: P.white, border: `1px solid ${P.border}`, boxShadow: "0 2px 12px rgba(26,61,40,0.04)" }}>
                <div style={{ width: 52, height: 52, borderRadius: 14, background: P.mint, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, margin: "0 auto 16px", border: `1px solid ${P.borderLight}` }}>{c.icon}</div>
                <div style={{ fontSize: 11, fontWeight: 700, color: P.muted, textTransform: "uppercase", letterSpacing: "0.07em", marginBottom: 8 }}>{c.title}</div>
                <div style={{ fontSize: 14, color: P.forest, fontWeight: 600, whiteSpace: "pre-line", lineHeight: 1.5 }}>{c.text}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Modal de login */}
      {showForm && (
        <div style={{ position: "fixed", inset: 0, zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(26,61,40,0.5)", backdropFilter: "blur(8px)" }} onClick={() => setShowForm(false)}>
          <div style={{ position: "relative" }} onClick={e => e.stopPropagation()}>
            <button onClick={() => setShowForm(false)} style={{ position: "absolute", top: -14, right: -14, zIndex: 10, width: 32, height: 32, borderRadius: "50%", background: "white", border: "none", cursor: "pointer", fontSize: 18, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 2px 10px rgba(0,0,0,0.15)", color: P.slate }}>✕</button>
