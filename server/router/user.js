...
api.get("/user/me", [md_auth.asureAuth, md_auth.hasRole([1])], UserController.getMe);
...
api.get("/users", [md_auth.asureAuth, md_auth.hasRole([1, 2, 3, 4])], UserController.getUsers);
